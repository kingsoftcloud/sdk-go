...
type QueryItemBillsRequest struct {
	*ksyunhttp.BaseRequest
	...
	SubAccountId      *int64  `json:"SubAccountId,omitempty" name:"SubAccountId"`
...
type QueryProductTypesResponse struct {
	*ksyunhttp.BaseResponse
	RequestId *string `json:"RequestId" name:"RequestId"`
	Data      []struct {
		ProductGroupId   *int64  `json:"ProductGroupId" name:"ProductGroupId"`
		ProductGroupName *string `json:"ProductGroupName" name:"ProductGroupName"`
		ProductTypeId    *int64  `json:"ProductTypeId" name:"ProductTypeId"`
