	...
	AlertingProductSet []struct {
		...
		ResourceSet []struct {
			...
			Policies  []struct {
				...
				CurValue    *float64 `json:"CurValue" name:"CurValue"`
...
func (r *GetPrometheusTokenRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

type GetPrometheusTokenResponse struct {
	*ksyunhttp.BaseResponse
	RequestID *string `json:"RequestID" name:"RequestID"`
	Token     *string `json:"Token" name:"Token"`
}

func (r *GetPrometheusTokenResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *GetPrometheusTokenResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type PutDefaultEventPolicyRequest struct {
	*ksyunhttp.BaseRequest
	PolicyName *string `json:"PolicyName,omitempty" name:"PolicyName"`
}

func (r *PutDefaultEventPolicyRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

type PutDefaultEventPolicyResponse struct {
	*ksyunhttp.BaseResponse
	RequestId                 *string `json:"requestId" name:"requestId"`
	Code                      *string `json:"code" name:"code"`
	Message                   *string `json:"message" name:"message"`
	DefaultPolicyName         *string `json:"DefaultPolicyName" name:"DefaultPolicyName"`
	PreviousDefaultPolicyName *string `json:"PreviousDefaultPolicyName" name:"PreviousDefaultPolicyName"`
	UpdatedAt                 *int    `json:"UpdatedAt" name:"UpdatedAt"`
}

func (r *PutDefaultEventPolicyResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *PutDefaultEventPolicyResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
